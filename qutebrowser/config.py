...
c.colors.completion.fg = ['#BED2E0', '#d0ffff', '#d0ffff']

# Background color of the completion widget for odd rows.
# Type: QssColor
c.colors.completion.odd.bg = '#17181b'

# Background color of the completion widget for even rows.
# Type: QssColor
c.colors.completion.even.bg = '#2d2f36'

# Foreground color of completion widget category headers.
# Type: QtColor
c.colors.completion.category.fg = '#d6efff'
...
# Type: QssColor
c.colors.completion.category.border.top = '#2d2f36'

# Bottom border color of the completion widget category headers.
# Type: QssColor
c.colors.completion.category.border.bottom = '#2d2f36'

# Foreground color of the selected completion item.
# Type: QtColor
c.colors.completion.item.selected.fg = '#d0ffff'

# Background color of the selected completion item.
# Type: QssColor
c.colors.completion.item.selected.bg = '#2d2f36'

# Foreground color of the matched text in the selected completion item.
# Type: QtColor
c.colors.completion.item.selected.match.fg = '#8bb8d0'

# Foreground color of the matched text in the completion.
# Type: QtColor
c.colors.completion.match.fg = '#798A93'
...
# Type: QssColor
c.colors.downloads.bar.bg = '#17181b'

# Background color for downloads with errors.
# Type: QtColor
c.colors.downloads.error.bg = '#6D7885'

# Font color for hints.
# Type: QssColor
c.colors.hints.fg = '#17181b'

# Font color for the matched part of hints.
# Type: QtColor
c.colors.hints.match.fg = '#9BA0A6'

# Background color of an info message.
# Type: QssColor
c.colors.messages.info.bg = '#17181b'

# Background color of the statusbar.
# Type: QssColor
c.colors.statusbar.normal.bg = '#17181b'
...
# Type: QssColor
c.colors.statusbar.insert.bg = '#17181b'

# Background color of the statusbar in passthrough mode.
# Type: QssColor
c.colors.statusbar.passthrough.bg = '#2d2f36'

# Background color of the statusbar in command mode.
# Type: QssColor
c.colors.statusbar.command.bg = '#17181b'
...
# Type: QssColor
c.colors.tabs.bar.bg = '#17181b'

# Background color of unselected odd tabs.
# Type: QtColor
c.colors.tabs.odd.bg = '#9BA0A6'

# Background color of unselected even tabs.
# Type: QtColor
c.colors.tabs.even.bg = '#b4ceec'

# Background color of selected odd tabs.
# Type: QtColor
c.colors.tabs.selected.odd.bg = '#2d2f36'

# Background color of selected even tabs.
# Type: QtColor
c.colors.tabs.selected.even.bg = '#2d2f36'
...
# Type: QtColor
c.colors.tabs.pinned.selected.odd.bg = '#17181b'

# Background color of pinned selected even tabs.
# Type: QtColor
c.colors.tabs.pinned.selected.even.bg = '#2d2f36'
